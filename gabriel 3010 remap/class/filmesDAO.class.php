...
function calcularGenero($idGenero) {
    $conexao = mysqli_connect("localhost", "root", "", "gabriel_ecommerce");
    
    $nomeGenero = mysqli_query($conexao, "SELECT nome FROM categorias WHERE idCategoria = '".$idGenero."'");
...
class FilmesDAO extends Connection
{
